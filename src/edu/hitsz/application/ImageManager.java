...
public class ImageManager {
    ...
    public static BufferedImage BACKGROUND_IMAGE_EZ;
    public static BufferedImage BACKGROUND_IMAGE_NM;
    public static BufferedImage BACKGROUND_IMAGE_HD;
    ...
    static {
        try {
            ...
            BACKGROUND_IMAGE_EZ = ImageIO.read(new FileInputStream("src/images/bg.jpg"));
            BACKGROUND_IMAGE_NM = ImageIO.read(new FileInputStream("src/images/bg4.jpg"));
            BACKGROUND_IMAGE_HD = ImageIO.read(new FileInputStream("src/images/bg5.jpg"));

            HERO_IMAGE = ImageIO.read(new FileInputStream("src/images/hero.png"));
            MOB_ENEMY_IMAGE = ImageIO.read(new FileInputStream("src/images/mob.png"));
            ELITE_ENEMY_IMAGE = ImageIO.read(new FileInputStream("src/images/elite.png"));
            SUPER_ENEMY_IMAGE = ImageIO.read(new FileInputStream("src/images/super.png"));
            ...
            CLASSNAME_IMAGE_MAP.put(NormalEnemy.class.getName(), MOB_ENEMY_IMAGE);
